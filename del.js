...
var _$Delayer_Task = function(id,t,cb,secs) {
	this.t = t;
	this.cb = cb;
	this.id = id;
	this.secs = secs;
...
Delayer.prototype = {
	...
	,addMs: function(id,cb,ms) {
		this.delays.push(new _$Delayer_Task(id,this.now + ms / 1000 * this.fps,cb));
		haxe_ds_ArraySort.sort(this.delays,$bind(this,this.cmp));
	}
	,addS: function(id,cb,t,secs) {
		this.delays.push(new _$Delayer_Task(id,this.now + this.delayTime + secs * this.fps,cb,Math.ceil(this.delayTime + secs * this.fps)));
		this.calcdelayTime();
	}
	,addF: function(id,cb,frames) {
		this.delays.push(new _$Delayer_Task(id,this.now + frames,cb));
		haxe_ds_ArraySort.sort(this.delays,$bind(this,this.cmp));
	}
	,update: function(dt) {
	...
	,calcdelayTime: function() {
		...
		Lambda.fold(this.delays,function(a,b) {
			haxe_Log.trace(_gthis.delays.length + "-" + a.secs,{ fileName : "src/Delayer.hx", lineNumber : 122, className : "Delayer", methodName : "calcdelayTime"});
		...
		while(_g < _g1) {
			var i = _g++;
			result[i] = Debug.Log(_this[i].secs,null,{ fileName : "src/Delayer.hx", lineNumber : 129, className : "Delayer", methodName : "calcdelayTime"});
		}
	}
	,update2: function(dt) {
		haxe_Log.trace("update length=" + this.delays.length + " delays[0]:" + this.delays[0].secs + " now:" + this.now,{ fileName : "src/Delayer.hx", lineNumber : 135, className : "Delayer", methodName : "update2"});
		if(this.delays.length > 0 && this.delays[0].secs <= this.now) {
			var d = this.delays.shift();
			d.cb();
			d.cb = null;
		}
...
Main.__name__ = "Main";
Main.main = function() {
	haxe_Log.trace("Hello, world!",{ fileName : "src/Main.hx", lineNumber : 8, className : "Main", methodName : "main"});
	var d = new Delayer(60);
	d.addS(null,function() {
		haxe_Log.trace("ok" + thx__$Time_Time_$Impl_$.toString(thx__$Time_Time_$Impl_$.create(0,0,0,Main.delta | 0)),{ fileName : "src/Main.hx", lineNumber : 13, className : "Main", methodName : "main"});
	},2.,2);
	d.addS(null,function() {
		haxe_Log.trace("then" + thx__$Time_Time_$Impl_$.toString(thx__$Time_Time_$Impl_$.create(0,0,0,Main.delta | 0)),{ fileName : "src/Main.hx", lineNumber : 14, className : "Main", methodName : "main"});
	},5.,5);
	d.addS(null,function() {
		haxe_Log.trace("way " + thx__$Time_Time_$Impl_$.toString(thx__$Time_Time_$Impl_$.create(0,0,0,Main.delta | 0)),{ fileName : "src/Main.hx", lineNumber : 15, className : "Main", methodName : "main"});
	},2.,2);
	haxe_Log.trace("pop" + d.delayTime,{ fileName : "src/Main.hx", lineNumber : 17, className : "Main", methodName : "main"});
	thx_Timer.frame(function(_delta) {
		Main.delta += _delta;
		d.update2(1);
	});
};
	...
	f = function(v) {
		if(((v) instanceof Array) && v.__enum__ == null) {
				...
				if(v.length == 0) {
					...
					return thx_Either.Right(thx_Arrays.reducei(a,function(map,value,i) {
						...
						case 1:
							...
							while(k.hasNext()) {
								var k1 = k.next();
								var value1 = __map_reserved[k1] != null ? _g1.getReserved(k1) : _g1.h[k1];
								var key1 = "" + i + "." + k1;
			...
			return thx_Either.Right(thx_Arrays.reduce(Reflect.fields(v),function(map1,key2) {
				...
				case 1:
					var _g11 = _g3.value;
					if(!new haxe_ds__$StringMap_StringMapIterator(_g11,_g11.arrayKeys()).hasNext()) {
						var key4 = "" + key2;
						var value2 = { };
						...
						while(k2.hasNext()) {
							var k3 = k2.next();
							var value3 = __map_reserved[k3] != null ? _g11.getReserved(k3) : _g11.h[k3];
							var key5 = "" + key2 + "." + k3;
...
thx__$Validation_Validation_$Impl_$.ap = function(this1,v,s) {
	...
	case 1:
		...
		switch(_g3._hx_index) {
		case 0:
			return thx_Either.Left(_g3.value);
		case 1:
			return thx_Either.Right(_g3.value(_g2));
		}
		break;
	}
};
...
thx__$Validation_Validation_$Impl_$.orElseV = function(this1,other,s) {
	...
	case 0:
		...
		switch(_g._hx_index) {
		case 0:
			return thx_Either.Left((thx__$Semigroup_Semigroup_$Impl_$.get_append(s))(_g2,_g.value));
		case 1:
			return other;
		}
		break;
